    ...
    <section
      ...
      <FadeUpAnimation className="container">
        <div className="relative z-10 text-center ">
          <p className="mb-8 font-medium uppercase max-lg:mb-4">🤖 YAPAY ZEKA DESTEKLİokok</p>
          ...
          <p className="mx-auto mb-3 max-w-[590px] max-md:mb-8">
            Tüm iletişim kanallarını tek bir panelde birleştirerek süreçlerinizi optimize eder. Harika bir müşteri
            deneyimi sunun ve görüşmeleri satışa dönüştürün.
          </p>
          <p className="mb-12">
