          ...
          <div className="grid grid-cols-3 gap-8 max-md:grid-cols-1">
            <FadeUpAnimation className="rounded-medium bg-white p-2.5 shadow-box dark:bg-dark-200">
              <div className=" h-full rounded border border-dashed border-gray-100 p-10 text-center dark:border-borderColor-dark ">
                ...
                <h3 className="mb-2.5">Adress</h3>
                <p>Casper Wyoming United States</p>
              </div>
            </FadeUpAnimation>
            <FadeUpAnimation className="rounded-medium bg-white p-2.5 shadow-box dark:bg-dark-200">
              <div className="h-full rounded border border-dashed border-gray-100 p-10 text-center dark:border-borderColor-dark max-lg:p-5">
                ...
                <h3 className="mb-2.5">Email </h3>
                <Link href="mailto:hallo@aplio.com"> support@dialogfusion.com </Link>
              </div>
            </FadeUpAnimation>
            <FadeUpAnimation className="rounded-medium bg-white p-2.5 shadow-box dark:bg-dark-200">
              <div className=" h-full rounded border border-dashed border-gray-100 p-10 text-center dark:border-borderColor-dark">
              ...
              38.3086 9.89256C38.3086 21.8246 21.8789 38.2653 9.94143 38.2653L9.93362 38.32Z"
                ...
                <h3 className="mb-2.5">Anlık Destek</h3>
                <span>Sağ alttaki canlı destek butonumuzdan destek alabilirsin</span>
              </div>
            </FadeUpAnimation>
          </div>
        </div>
