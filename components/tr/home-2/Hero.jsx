      ...
      <div className="container">
        <div className="relative z-10 grid grid-cols-12 items-end gap-5">
          <FadeUpAnimation className="max-md:col-span-full max-md:mb-[350px] md:col-span-7">
            <p className="mb-4 font-medium uppercase">🤖 YAPAY ZEKA DESTEKLİ</p>
            <h1 className="mb-10">
            Tüm kanallar
            ...
            <span className="block mt-4">İsterseniz yapay zeka desteği ve otomasyonlar ile müşterilerini en doğru şekilde yönlendirin.</span></p>
